...
WebUI.click(findTestObject('Object Repository/Forgot_Pasword_page/Page_Khch hng ng nhp - FAHASA.COM/div_OTP hp l'))
...
if (password.trim.length == 0 || password.trim.length <6) {
	WebUI.verifyElementNotClickable(findTestObject('Object Repository/Forgot_Pasword_page/Page_Khch hng ng nhp - FAHASA.COM/button_Xc nhn'))
}
else {
